...
public interface CommunityServiceNew {
    ...
    String changeCommunityIcon(String idComunidade, MultipartFile icone, HttpServletRequest request);

    String updateCommunity(String id, UpdateCommunityRequest updateCommunityRequest, BindingResult result);
